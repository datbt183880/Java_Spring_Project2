...
import com.hust.prj2.service.ContactService;
...
public class RestApiController {
    ...
    @RequestMapping(value = "/contact/by/{age}", method = RequestMethod.GET)
    public List<Contact> findContactByAge(@PathVariable("age") int age){
        List<Contact> contact = contactService.getContactByAge(age);
        if (contact == null) {
